...
///asd
    ...
    public function check_logged_in_another_phone($user_code,$remember_token)
    {
    ...
    /*public function returnError_with_data($errNum, $msg ,$key,$value)
    {
        return response()->json([
            'status' => false,
            'code' => $errNum,
    ...
    public function returnError_with_data($key, $key2, $value, $msg = "")
    {
        return response()->json([
            'status' => true,
            'code' => "402",
    ...
    public function returnError_with_data_and_false_status($key, $key2, $value, $msg = "")
    {
        return response()->json([
            'status' => false,
            'code' => "666",
    ...
    public function customreturnData($key, $key2, $value, $msg = "")
    {
        return response()->json([
            'status' => true,
            'code' => "200",
    ...
    public function customreturnDatawithNewParam($key, $key2, $value,$param , $paramValue, $msg = "" )
    {
        return response()->json([
            'status' => true,
            'code' => "200",
            'msg' => $msg,
            $key => [$key2=>$value ,$param => $paramValue]
        ]);
    }
    //custom //custom //custom //custom //custom //custom //custom 
    public function customreturnDataLoggedin($key, $key2, $value, $msg = "")
    {
        return response()->json([
            'status' => true,
            'code' => "401",
